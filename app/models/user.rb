class User < ApplicationRecord
  ...
  validates :family_name_kana, format: { with: /\A[ァ-ヶー]+\z/ , message: "is invalid. Input full-width characters" }, presence: true
  validates :given_name, format: { with: /\A[ぁ-んァ-ヶ一-龥々ー]+\z/ }, presence: true
  validates :given_name_kana, format: { with: /\A[ァ-ヶー]+\z/ , message: "is invalid. Input full-width characters" }, presence: true
